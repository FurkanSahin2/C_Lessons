#include <stdio.h>
#include <stdlib.h>
//  Define: Bütün program içerisinde geçerli olabilecek tanýmlama yapmama olanak saðlar. Yani; öniþlemci komutudur. 
#define puan 2.19 // Bu yazdýðýmýz sayesinde program derlenmeye baþlamadan önce kod kýsmýnda (main kýsmýnda) puan gördüðü yere "2.25" atayacak.
#define puan2 3.47
#define puan3 2.48
#define puan4 1.75
