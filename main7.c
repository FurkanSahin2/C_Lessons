...
int main() {
    ...
    //Aylýk maaþý 2500 olan birisinin maaþýna %12 zam yapýlýrsa yeni maaþ ne kadar olur
    printf ("***Zam Maasý Hesaplama***\n\n");
    ...
    //Aylýk maaþý 2500 olan birisinin maaþýna belirli bir zam yapýlýrsa yeni maaþ ne kadar olur?
